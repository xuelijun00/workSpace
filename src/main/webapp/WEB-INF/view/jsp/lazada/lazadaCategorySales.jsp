...
function queryData(){
	...
	var chartUrl =  contextPath + '/report/ebayoverseascategory/grid?business=lazada&st=' + startDate + "&et=" + endDate+ "&oldsku=" + oldsku+ "&category=" + category;	
...
(function(){
	...
	var startDate = $("#start_date").val();
	var endDate = $("#end_date").val();
	var chartUrl =  contextPath + '/report/ebayoverseascategory/grid?business=lazada&st=' + startDate + "&et=" + endDate;
	var series = [];

...
function queryData(){
	...
	var chartUrl =  contextPath + '/report/ebay_domestic/category/grid?business=lazada&startDate=' + startDate + "&endDate=" + endDate+ "&category=" + category;	
...
function exportData(){
	...
	var startDate = $("#start_date").val();
	var endDate = $("#end_date").val();
	var fileName = "lazada业务线每日品类销售数据" + startDate +"-"+ endDate + ".csv";
...
(function(){
	...
	var startDate = $("#start_date").val();
	var endDate = $("#end_date").val();
	var chartUrl =  contextPath + '/report/ebay_domestic/category/grid?business=lazada&startDate=' + startDate + "&endDate=" + endDate;
	var series = [];
	
	common.grid({
		title:"lazada业务线每日品类销售数据"
		,url:chartUrl

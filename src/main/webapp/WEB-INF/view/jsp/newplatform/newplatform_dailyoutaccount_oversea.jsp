...
<div class="wrapper wrapper-content">
    <div class="ibox-title"><h5>新平台账号维度每日发货数据(海外仓)(注意：本页面货币的单位，均为人民币（元）)</h5></div>
...
function getUrl(){
	...
	var url = "";
		url = contextPath + '/report/daily_out_account_oversea/newPlatform/grid?startDate=' + startDate + "&endDate=" + endDate;
...
function exportData(){
	...
	var startDate = $("#start_date").val();
	var endDate = $("#end_date").val();
	var fileName = "新平台账号维度每日发货数据(海外仓)" + startDate +"-"+ endDate + ".csv";
...
function plaChangeType(){
	...
	$.ajax({
		url : contextPath + "/report/daily_out_account_oversea/newPlatform/warehouseType?platform=" + platform,
		cache : false,
		type:"get",
		async: false,
		success : function(data) {
	...
	$.ajax({
		url : contextPath + "/report/daily_out_account_oversea/newPlatform/warehouseName?platform=" + platform,
		cache : false,
		type:"get",
		async: false,
		success : function(data) {
...
function typeChangeName(){
	var platform = $("#platform").val();
	var	warehouseType = $("#warehouseType").val();
	var url = contextPath + '/report/daily_out_account_oversea/newPlatform/warehouseName';
...
(function(){
	...
	$.ajax({
		url : contextPath + "/report/daily_out_account_oversea/newPlatform/accounts",
		cache : false,
		type:"get",
		async: false,
		success : function(data) {
	...
	$.ajax({
		url : contextPath + "/report/daily_out_account_oversea/newPlatform/platform",
		cache : false,
		type:"get",
		async: false,
		success : function(data) {
	...
	$.ajax({
		url : contextPath + "/report/daily_out_account_oversea/newPlatform/warehouseType",
		cache : false,
		type:"get",
		async: false,
		success : function(data) {
	...
	$.ajax({
		url : contextPath + "/report/daily_out_account_oversea/newPlatform/warehouseName",
		cache : false,
		type:"get",
		async: false,
		success : function(data) {

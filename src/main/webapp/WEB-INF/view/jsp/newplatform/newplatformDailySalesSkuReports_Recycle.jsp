...
<div class="wrapper wrapper-content">
    <div class="ibox-content">
        ...
        <h2 class="text-center">新平台业务线sku环比增长数据折线图</h2>
...
function getUrl(type){//拼接url
	...
	var url = "";
	if(type === 1){ 	
		url = contextPath + '/report/sku_recycle/newPlatform/grid?&startDate=' + startDate + "&endDate=" + endDate+ "&skuOld=" + oldsku+ "&sku=" + sku;
	}else{
		url = contextPath + '/report/sku_recycle/newPlatform/chart?&startDate=' + startDate + "&endDate=" + endDate+ "&sku=" + sku;
	}
	if(business !== 'all'){
...
function exportData(){
	...
	var fileName = "新平台业务线sku环比增长数据" + startDate +"-"+ endDate +"-"+ business + ".csv";
...
(function(){	
	...
	$.ajax({
		url : contextPath + '/report/sku_recycle/newPlatform/business',
		cache : false,
		type:"get",
		async: false,
		success : function(data) {

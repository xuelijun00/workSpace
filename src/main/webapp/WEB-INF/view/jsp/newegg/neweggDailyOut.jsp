...
<div class="wrapper wrapper-content">
    <div class="ibox-title"><h5>新蛋每日发货数据 </h5></div>
...
function getUrl(){
	var url = contextPath + "/report/daily_out_report/each_platform/grid?platform=new_Newegg";
...
function exportGridData(){
	var fileName = "新蛋每日发货数据 " + new Date().getTime() + ".csv";

...
function queryData(){
	...
	var chartUrl =  contextPath + '/report/ebayoverseassku/grid?business=new_newegg&st=' + startDate + "&et=" + endDate+ "&oldsku=" + oldsku+ "&sku=" + sku;	
...
(function(){
	...
	var startDate = $("#start_date").val();
	var endDate = $("#end_date").val();
	var chartUrl =  contextPath + '/report/ebayoverseassku/grid?business=new_newegg&st=' + startDate + "&et=" + endDate;
	var series = [];
	
	common.grid({
		title:"newegg业务线每日sku销售数据"
		,url:chartUrl

...
function exportData(){
	...
	var chartUrl =  contextPath + '/report/ebay_domestic/sku/chart?business=new_newegg&st=' + startDate + "&et=" + endDate+ "&oldsku=" + oldsku+ "&sku=" + sku;	
	$.ajax({
		url : chartUrl,
		cache : false,
		type:"get",

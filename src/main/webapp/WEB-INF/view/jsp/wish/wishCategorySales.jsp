...
function queryData(){
	...
	var chartUrl =  contextPath + '/report/ebay_domestic/category/grid?business=wish&startDate=' + startDate + "&endDate=" + endDate+ "&category=" + category;	
...
(function(){
	...
	var startDate = $("#start_date").val();
	var endDate = $("#end_date").val();
	var chartUrl =  contextPath + '/report/ebay_domestic/category/grid?business=wish&startDate=' + startDate + "&endDate=" + endDate;
	var series = [];
	
	common.grid({
		title:"wish业务线每日品类销售数据"
		,url:chartUrl

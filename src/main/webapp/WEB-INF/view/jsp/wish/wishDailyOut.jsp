...
<div class="wrapper wrapper-content">
    <div class="ibox-title"><h5>Wish每日发货数据 </h5></div>
...
function getUrl(){
	var url = contextPath + "/report/daily_out_report/each_platform/grid?platform=wish";
...
function exportGridData(){
	var fileName = "Wish每日发货数据 " + new Date().getTime() + ".csv";

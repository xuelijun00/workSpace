...
<div class="wrapper wrapper-content">
    <div class="ibox-title"><h5>Wish SKU净利明细(注意：本页面货币的单位，只有柱状图（税后综合净利）是美元，其他均为人民币（元）)</h5></div>
    ...
    <form class="form-inline">
        ...
        <h2 class="text-center">Wish税后综合净利（美元）和税后综合利润率（按日期汇总）</h2>
		<div class="hr-line-dashed"></div>
...
function getUrl(type){
	...
	if(type === 1){
		...
		url = contextPath + '/report/profit_details/chart?platform=wish&startDate=' + startDate + "&endDate=" + endDate;
	}
...
function exportData(){
	...
	var fileName = "Wish SKU净利明细" + startDate +"-"+ endDate + ".csv";

...
function getUrl(type){//拼接url
	...
	return contextPath + '/report/dailyBuyerCountrySales/grid?platform=wish&startDate=' + startDate + "&endDate=" + endDate + "&buyerCountry=" + buyerCountry;
	/* } */
}
function queryData(){	
...
(function(){
	...
	$.ajax({
		url : contextPath + "/report/dailyBuyerCountrySales/buyerCountry?platform=wish",
		cache : false,
		type:"get",
		async: false,
		success : function(data) {

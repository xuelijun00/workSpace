...
function getUrl(type){//拼接url
	...
	if(type === 1){ 	
		return contextPath + '/report/ebay_domestic/wishSku/grid?st=' + startDate + "&et=" + endDate+ "&oldsku=" + oldsku+ "&sku=" + sku;
	}else{
		return contextPath + '/report/ebay_domestic/wishSku/chart?st=' + startDate + "&et=" + endDate+ "&oldsku=" + oldsku+ "&sku=" + sku;
	}
}
...
function exportData(){
	...
	var chartUrl =  contextPath + '/report/ebay_domestic/wishSku/chart?st=' + startDate + "&et=" + endDate+ "&oldsku=" + oldsku+ "&sku=" + sku;	
	$.ajax({
		url : chartUrl,
		cache : false,
		type:"get",

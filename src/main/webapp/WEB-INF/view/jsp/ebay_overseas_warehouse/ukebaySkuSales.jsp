...
<div class="wrapper wrapper-content">
    <div class="ibox-title"><h5>英仓sku销售报表</h5></div>
...
function queryData(){
	...
	var chartUrl =  contextPath + '/report/ebayoverseassku/grid?business=Ebay_UK&st=' + startDate + "&et=" + endDate+ "&oldsku=" + oldsku+ "&sku=" + sku;	
...
(function(){
	...
	var startDate = $("#start_date").val();
	var endDate = $("#end_date").val();
	var chartUrl =  contextPath + '/report/ebayoverseassku/grid?business=Ebay_UK&st=' + startDate + "&et=" + endDate;
	var series = [];

...
<div class="wrapper wrapper-content">
    <div class="ibox-title"><h5>英仓销售报表</h5></div>
...
function getUrl(type){//拼接url
	...
	if(type === 1){
		return contextPath + '/report/dailysales/grid?business=Ebay_UK&st=' + startDate + "&et=" + endDate;
	}else{
		return contextPath + '/report/dailysales/chart?business=Ebay_UK&st=' + startDate + "&et=" + endDate;
	}
}
function queryData(){

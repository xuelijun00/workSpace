...
<div class="wrapper wrapper-content">
    <div class="ibox-title"><h5>英仓品类销售报表</h5></div>
...
function queryData(){
	...
	var chartUrl =  contextPath + '/report/ebayoverseascategory/grid?business=Ebay_UK&st=' + startDate + "&et=" + endDate+ "&oldsku=" + oldsku+ "&category=" + category;	
...
function exportData(){
	...
	var startDate = $("#start_date").val();
	var endDate = $("#end_date").val();
	var fileName = "Ebay业务线英仓每日品类销售数据" + startDate +"-"+ endDate + ".csv";
...
(function(){
	...
	var startDate = $("#start_date").val();
	var endDate = $("#end_date").val();
	var chartUrl =  contextPath + '/report/ebayoverseascategory/grid?business=Ebay_UK&st=' + startDate + "&et=" + endDate;
	var series = [];
	
	common.grid({
		title:"Ebay业务线英仓每日品类销售数据"
		,url:chartUrl

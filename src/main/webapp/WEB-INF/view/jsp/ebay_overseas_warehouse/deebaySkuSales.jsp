...
function queryData(){
	...
	var chartUrl =  contextPath + '/report/ebayoverseassku/grid?business=Ebay_PO&st=' + startDate + "&et=" + endDate+ "&oldsku=" + oldsku+ "&sku=" + sku;	
...
(function(){
	...
	var startDate = $("#start_date").val();
	var endDate = $("#end_date").val();
	var chartUrl =  contextPath + '/report/ebayoverseassku/grid?business=Ebay_PO&st=' + startDate + "&et=" + endDate;
	var series = [];

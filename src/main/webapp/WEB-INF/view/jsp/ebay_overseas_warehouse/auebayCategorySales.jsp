...
function queryData(){
	...
	var chartUrl =  contextPath + '/report/ebay_domestic/category/grid?business=Ebay_AU&startDate=' + startDate + "&endDate=" + endDate+ "&category=" + category;	
...
function exportData(){
	...
	var startDate = $("#start_date").val();
	var endDate = $("#end_date").val();
	var fileName = "Ebay业务线澳洲仓每日品类销售数据" + startDate +"-"+ endDate + ".csv";
...
(function(){
	...
	var startDate = $("#start_date").val();
	var endDate = $("#end_date").val();
	var chartUrl =  contextPath + '/report/ebay_domestic/category/grid?business=Ebay_AU&startDate=' + startDate + "&endDate=" + endDate;
	var series = [];
	
	common.grid({
		title:"Ebay业务线澳洲仓每日品类销售数据"
		,url:chartUrl

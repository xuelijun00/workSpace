...
<div class="wrapper wrapper-content">
    <div class="ibox-title"><h5>美仓品类销售报表</h5></div>
    ...
    <form class="form-inline">
		...
		<div class="ibox-content">
			<table id="list_category_us" class="tablegrid"></table>
			<div id="pager_category_us"></div>
		</div>
...
<!--加本页面 的js文件与js代码-->
	...
	<script type="text/javascript" src="js/report/usebaycategory.js" ></script>
	<!--加本页面 的js文件与js代码-->
</body>
</html>

...
function queryData(){
	...
	var chartUrl =  contextPath + '/report/ebay_domestic/category/grid?business=Ebay_US&startDate=' + startDate + "&endDate=" + endDate+ "&category=" + category;	
...
(function(){
	...
	var startDate = $("#start_date").val();
	var endDate = $("#end_date").val();
	var chartUrl =  contextPath + '/report/ebay_domestic/category/grid?business=Ebay_US&startDate=' + startDate + "&endDate=" + endDate;
	var series = [];
	
	common.grid({
		title:"Ebay业务线美仓每日品类销售数据"
		,url:chartUrl

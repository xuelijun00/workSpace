...
<div class="wrapper wrapper-content">
    <div class="ibox-title"><h5>沃尔玛SKU净利明细(注意：本页面货币的单位，只有柱状图（税后综合净利）是美元，其他均为人民币（元）) </h5></div>
    ...
    <form class="form-inline">
        ...
        <h2 class="text-center">沃尔玛税后综合净利（美元）和税后综合利润率（按日期汇总）</h2>
		<div class="hr-line-dashed"></div>
...
function getUrl(type){
	...
	if(type === 1){
		...
		url = contextPath + '/report/profit_details/walmart/chart?startDate=' + startDate + "&endDate=" + endDate;
	}
...
function exportData(){
	...
	var fileName = "沃尔玛SKU净利明细" + startDate +"-"+ endDate + ".csv";
...
(function(){
	...
	common.grid({
		title:"沃尔玛SKU净利明细"
		,url:getUrl(1)
		,colNames:[ '内订单号','平台名称', '管理员', '账号', 'sku', 'sku中文名', '发货数量', '平均价', '发货收入（元）', '退款', '成本', '毛利','运费', '平台费用', '包材费', '订单执行费', '运营费', '边际利润', '税前综合净利', '税后综合净利（元）', '税后综合利润率', '报表时间', '平台订单号']
		,colModel:[ {name : 'erpOrdersId',index : 'erpOrdersId',sortable : "true",width : 125,formatter:'long'},
		            ...
		            {name : 'skuCnName',index : 'sku_cnname',width : 210},
		            ...
		            {name : 'orderExecutionFee',index : 'orderExecutionFee',sortable : "true",width : 130,formatter:'integer', formatoptions:{thousandsSeparator: ',', defaulValue:"",decimalPlaces:2},align:"right"},
		            ...
		            {name : 'netProfit',index : 'profit',sortable : "true",width : 130,formatter:'integer', formatoptions:{thousandsSeparator: ',', defaulValue:"",decimalPlaces:2},align:"right"},

...
function getUrl(type){//拼接url
	...
	if(type === 1){
		return contextPath + '/report/sales_performance/grid?business=walmart&startDate=' + startDate + "&endDate=" + endDate;
	}else{
		return contextPath + '/report/sales_performance/chart?business=walmart&startDate=' + startDate + "&endDate=" + endDate;
	}
}
function queryData(){

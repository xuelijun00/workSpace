...
function queryData(){
	...
	var chartUrl =  contextPath + '/report/ebay_domestic/category/grid?business=walmart&st=' + startDate + "&et=" + endDate+ "&category=" + category;	
...
(function(){
	...
	var startDate = $("#start_date").val();
	var endDate = $("#end_date").val();
	var chartUrl =  contextPath + '/report/ebay_domestic/category/grid?business=walmart&st=' + startDate + "&et=" + endDate;
	var series = [];

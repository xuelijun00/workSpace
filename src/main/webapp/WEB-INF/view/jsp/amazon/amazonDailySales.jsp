...
function getUrl(type){//拼接url
	...
	if(type === 1){
		return contextPath + '/report/sales_performance/grid?business=amazon&startDate=' + startDate + "&endDate=" + endDate;
	}else{
		return contextPath + '/report/sales_performance/chart?business=amazon&startDate=' + startDate + "&endDate=" + endDate;
	}
}
function queryData(){
...
(function(){
	...
	common.grid({
		...
		,colModel:[ //jqGrid每一列的配置信息。包括名字，索引，宽度,对齐方式.....
		             ...
		             {name : 'sales',index : 'sales',width : 205,formatter:'integer', formatoptions:{thousandsSeparator: ','},align:"right", defaulValue:"",decimalPlaces:2}, 

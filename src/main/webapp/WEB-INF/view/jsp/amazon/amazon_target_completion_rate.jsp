...
<body class="gray-bg">
	<div class="wrapper wrapper-content">
	 	<div class="ibox-title"><h5>Amazon仓各月业绩完成率（注意：本页面的货币单位，均是（美元））</h5></div>
		...
		<form class="form-inline" id="form">
            ...
            <div class="form-group">
              <label>业务线：</label>
              <select class="form-control w120" id="name" >
              	<option value='亚马逊'>全部</option>
              	<option value='亚马逊一部'>亚马逊一部</option>
              	<option value='亚马逊二部'>亚马逊二部</option>
              </select>
            </div>
            <div class="form-group">
	...
	var test = {
			...
			var url = '';
			if(type === 1){
				url = contextPath + '/report/targetcompletioncrate/branch/grid?startMonth=' + startMonth + '&endMonth=' + endMonth;
			}else{
				url = contextPath + '/report/targetcompletioncrate/branch/histogram?startMonth=' + startMonth + '&endMonth=' + endMonth;
			}

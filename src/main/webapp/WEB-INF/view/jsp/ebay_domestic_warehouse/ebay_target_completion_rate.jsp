...
<body class="gray-bg">
	<div class="wrapper wrapper-content">
	 	<div class="ibox-title"><h5>eBay国内仓各月业绩完成率（注意：本页面的货币单位，均是（美元））</h5></div>
	...
	var test = {
			...
			var url = '';
			if(type === 1){
				url = contextPath + '/report/targetcompletioncrate/branch/grid?name=Ebay国内仓&startMonth=' + startMonth + '&endMonth=' + endMonth;
			}else{
				url = contextPath + '/report/targetcompletioncrate/branch/histogram?name=Ebay国内仓&startMonth=' + startMonth + '&endMonth=' + endMonth;
			}
			return url;
		},
			BUSINESS : 'Ebay国内仓'

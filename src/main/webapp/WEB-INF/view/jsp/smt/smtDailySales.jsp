...
function getUrl(type){//拼接url
	...
	if(type === 1){
		return contextPath + '/report/dailysales/grid?business=smt&st=' + startDate + "&et=" + endDate;
	}else{
		return contextPath + '/report/dailysales/chart?business=smt&st=' + startDate + "&et=" + endDate;
	}
}
function queryData(){

...
<div class="wrapper wrapper-content">
    <div class="ibox-content">
        ...
        <h2 class="text-center">SMT业务线sku环比增长数据折线图</h2>
...
function getUrl(type){//拼接url
	...
	if(type === 1){
		return contextPath + '/report/sku_recycle/smt/grid?&startDate=' + startDate + "&endDate=" + endDate+ "&skuOld=" + oldsku+ "&sku=" + sku;
	}else{
		return contextPath + '/report/sku_recycle/smt/chart?&startDate=' + startDate + "&endDate=" + endDate+ "&sku=" + sku;
	}
}
...
/* 	var sku = encodeURIComponent($('#sku').val());
	...
	var fileName = "SMT业务线sku环比增长数据" + startDate +"-"+ endDate + ".csv";

$(function () {
	...
	// 创建jqGrid组件
	jQuery("#list_sku_uk").jqGrid(
			{
				url : contextPath + '/report/ukebaysku/grid',//组件创建完成之后请求数据的url
	...
	/*创建jqGrid的操作按钮容器*/
	/*可以控制界面上增删改查的按钮是否显示*/
	jQuery("#list_sku_uk").jqGrid('navGrid', '#pager_sku_uk', {edit : false,add : false,del : false});

$(function () {
	...
	// 创建jqGrid组件
	jQuery("#list_category_us").jqGrid(
			{
				url : contextPath + '/report/usebaycategory/grid',//组件创建完成之后请求数据的url
	...
	/*创建jqGrid的操作按钮容器*/
	/*可以控制界面上增删改查的按钮是否显示*/
	jQuery("#list_category_us").jqGrid('navGrid', '#pager_category_us', {edit : false,add : false,del : false});

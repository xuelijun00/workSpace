$(function () {
	...
	jQuery("#list2").jqGrid(
			{
				url : contextPath + '/report/ebayoverseassku/grid?business=Ebay_UK',//组件创建完成之后请求数据的url
				...
				pager : '#pager_sku_uk',//表格页脚的占位符(一般是div)的id
	...
	/*创建jqGrid的操作按钮容器*/
	/*可以控制界面上增删改查的按钮是否显示*/
	jQuery("#list2").jqGrid('navGrid', '#pager_sku_uk', {edit : false,add : false,del : false});
...
function refreshGridData(){
	...
	var et = $('#end_date').val();
	var url = contextPath + '/report/ebayoverseassku/grid?st=' + st + "&et=" + et+ "&sku=" + sku+ "&oldsku=" + oldsku+ "&business=Ebay_UK";

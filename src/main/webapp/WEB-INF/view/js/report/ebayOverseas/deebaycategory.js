$(function () {
	...
	jQuery("#list2").jqGrid(
			{
				url : contextPath + '/report/ebayoverseascategory/grid?business=Ebay_PO',//组件创建完成之后请求数据的url
...
function refreshGridData(){
	...
	var et = $('#end_date').val();
	var url = contextPath + '/report/ebayoverseascategory/grid?st=' + st + "&et=" + et+ "&oldsku=" + oldsku+ "&category=" + category+ "&business=Ebay_PO";
